...
sh run_local.sh # running on your local machine

or 

sh run_server.sh # running on a server

# Please don't forget to update some parameters like data file name in run_local.sh/run_server.sh 
